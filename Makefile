...
.git/:
	curl --user 'marskar' https://api.github.com/user/repos --data '{"name":"gitpython","description":"An example of using GitPython."}'
	test -f README.rst || echo "include" >> README.rst
	git init
	git add --all
